...
replace (
	...
	github.com/ethereum/go-ethereum => github.com/mmsqe/go-ethereum v1.10.24-0.20250310065056-062bff5e676e
	// release/v1.4.x
	github.com/evmos/ethermint => github.com/mmsqe/ethermint v0.6.5-0.20250310035341-bd9e60b9a50e
