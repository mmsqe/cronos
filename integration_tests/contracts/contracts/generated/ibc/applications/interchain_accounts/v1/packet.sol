...
library IbcApplicationsInterchain_accountsV1InterchainAccountPacketData {
  ...
  //struct definition
  struct Data {
    PACKET_PROTO_GLOBAL_ENUMS.Type f_type;
    bytes data;
    string memo;
  }
  ...
  function _read_f_type(
    ...
    PACKET_PROTO_GLOBAL_ENUMS.Type x = PACKET_PROTO_GLOBAL_ENUMS.decode_Type(tmp);
    r.f_type = x;
    return sz;
  }
    ...
    returns (uint)
  {
    ...
    int32 _enum_f_type = PACKET_PROTO_GLOBAL_ENUMS.encode_Type(r.f_type);
  ...
  function _estimate(
    ...
    uint256 e;
    e += 1 + ProtoBufRuntime._sz_enum(PACKET_PROTO_GLOBAL_ENUMS.encode_Type(r.f_type));
...
library PACKET_PROTO_GLOBAL_ENUMS {
